...
public class ExerciseEdit extends FragmentActivity implements
	...
	// Références vers l'exercice à modifier
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// si l'exercice a editer n'est pas encore défini
		...
		if (idkey_exerciseToEdit == -1) {
			// si idkey_exerciseToEdit vaut toujours 1 à ce stade, c'est que la
			// clé n'a pas été passée correctement par l'intent. Surement une
			// erreur, on ferme l'activité
			finish();
		}

		// création de exerciseToEdit depuis la BDD
	...
	public void onValidateExercise(Exercise e) {
		...
		Toast.makeText(getApplicationContext(), "Modifications enregistrées.",
